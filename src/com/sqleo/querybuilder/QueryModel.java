...
import com.sqleo.querybuilder.syntax.QueryTokens._Base;
...
public class QueryModel implements Cloneable {
	/** Select Element of Antrl? */
	private QueryExpression queryExpression;
	private ArrayList<_Base> orderClause;
	...
	public QueryModel(String schema) {
		...
		orderClause = new ArrayList<_Base>();
	}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		qm.orderClause = (ArrayList<_Base>)orderClause.clone();
		return qm;
	}
